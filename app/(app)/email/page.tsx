...
export default async function EmailPreviewPage() {
  ...
  const [{ data: profile, error: profileError }, { data: recommendations, error: recommendationsError }] = await Promise.all([
    ...
    supabase
      ...
      .select("id, product_name, asin, amazon_url, reason, is_saved")
