...
- scene: The interface clears to one calm statement while seven days becomes a checked, confident outcome.
- voiceover: "Seven days to go. Already handled."
- duration: 4s
- transition_in: crossfade
- status: outline
- src: compositions/frames/05-handled.html
- type: benefit_highlight
- persuasion: Future pacing into peace of mind
- beat: confidence + relief
- blueprint: compose
- asset_candidates: assets/scroll-038.png — dashboard context with Maya among the people Alex remembers
- focal: assets/scroll-038.png
- roles: scroll-038 = dim background context and Maya portrait proof
- sfx: chime

Compose: use one calm value-line handoff and a long hold, with Maya's real people card as the supporting human proof.
Scene 1 (0.0–1.1s): Warm white field with Maya's person card softly cropped at right and a large `7 DAYS TO GO` line entering at upper-left through a restrained **gentle scale-swap settle** (`scale-swap-transition`). Asymmetric 60/40, quiet and spacious.
Scene 2 (1.1–2.7s): On “Already handled,” one orange underline sweeps left→right and the first line hands off upward to `ALREADY HANDLED.` through a single **slide-up crossfade** (`discrete-text-sequence`); a small outlined check draws beside it using **SVG self-draw** (`svg-path-draw`).
Scene 3 (2.7–4.0s): Hold the statement and Maya's supporting card fully still. This is the allocated breather; no secondary reveal, camera drift, or breathing.

narrativeRole: Translate the workflow into the feeling the viewer actually wants: being thoughtful without panic.
keyMessage: The deadline is no longer a source of stress.
