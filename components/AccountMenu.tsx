  ...
  return (
    <details className="group relative">
      ...
      <div className="absolute right-0 top-full z-50 mt-2 w-48 overflow-hidden rounded-2xl border border-cream-200 bg-white p-1.5 shadow-soft">
        ...
        {isAdmin && <Link href="/admin/products" className="flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-semibold text-primary-500 transition hover:bg-cream-100 hover:text-primary"><ShieldCheck size={15} /> Add products</Link>}
