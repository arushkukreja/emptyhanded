...
export default function GoogleAuthButton({ next = "/dashboard" }: { next?: string }) {
  ...
  return (
    <div>
      <button
        ...
        disabled={loading}
        className="focus-ring flex h-[52px] w-full items-center justify-center gap-3 rounded-full border border-cream-300 bg-white px-6 text-sm font-bold text-primary transition hover:border-primary-300 hover:bg-cream-50 disabled:cursor-not-allowed disabled:opacity-50"
      >
